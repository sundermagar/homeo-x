          ...
          <div className="dd-active-head-up" style={{ minHeight: '340px' }}>
            ...
            <div className="dd-hud-body" style={{ display: 'block' }}>
              ...
              >
                ...
                <div
                  className="skeleton-box"
                  style={{ width: '70px', height: '40px', borderRadius: '8px' }}
                />
                <div
                  className="skeleton-box"
                  style={{ width: '65px', height: '40px', borderRadius: '8px' }}
                />
              </div>
              <div style={{ display: 'flex', gap: '12px' }}>
                <div
                  className="skeleton-box"
                  style={{ width: '160px', height: '36px', borderRadius: '10px' }}
                />
                <div
                  className="skeleton-box"
                  style={{ width: '80px', height: '36px', borderRadius: '10px' }}
                />
              </div>
            </div>
          </div>
