              ...
              {Array.from({ length: cols }).map((_, colIndex) => (
                <td key={colIndex} style={{ padding: '16px 24px' }}>
                  <div
                    ...
                    style={{
                      height: '14px',
                      width: colIndex === 0 ? '40px' : colIndex === 1 ? '120px' : '80px',
                      borderRadius: '6px',
                    }}
                  />
                </td>
    ...
    <div className="pp-page-container pp-fade-in">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '24px' }}>
        ...
        <div style={{ flex: 1 }}>
          <div
            ...
            style={{ width: 'min(300px, 100%)', height: '28px', marginBottom: '8px' }}
          />
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <div
              className="skeleton-box"
              style={{ width: '100px', height: '22px', borderRadius: '12px' }}
            />
          </div>
        </div>
        <div style={{ display: 'flex', gap: '12px' }}>
      ...
      <div className="pp-card" style={{ padding: '24px' }}>
        ...
        >
          <div
            className="skeleton-box skeleton-text"
            style={{ width: '150px', height: '20px', marginBottom: 0 }}
          />
          <div
            className="skeleton-box"
