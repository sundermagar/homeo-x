      ...
      >
        ...
        <div style={{ flex: 2, position: 'relative', background: '#0F172A', minHeight: '40vh' }}>
          ...
          {!(isPaused || isRemotePaused) &&
            video?.remoteUsers?.map((u: any) => <AudioPlayer key={u.uid} track={u.audioTrack} />)}
        </div>
        <div
          style={{
            padding: '1rem',
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              height: 36,
              borderRadius: '50%',
              border: `1.5px solid ${video?.isMicOn ? '#6366F1' : '#FCA5A5'}`,
              background: video?.isMicOn ? '#EEF2FF' : '#FEF2F2',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              cursor: 'pointer',
          ...
          >
            {video?.isMicOn ? (
              <Mic style={{ width: 15, height: 15, color: '#6366F1' }} />
            ) : (
              <MicOff style={{ width: 15, height: 15, color: '#EF4444' }} />
            )}
          </button>
          <button
            ...
            style={{
              ...
              height: 36,
              borderRadius: '50%',
              border: `1.5px solid ${video?.isCameraOn ? '#6366F1' : '#FCA5A5'}`,
              background: video?.isCameraOn ? '#EEF2FF' : '#FEF2F2',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              cursor: 'pointer',
          ...
          >
            {video?.isCameraOn ? (
              <Video style={{ width: 15, height: 15, color: '#6366F1' }} />
            ) : (
              <VideoOff style={{ width: 15, height: 15, color: '#EF4444' }} />
            )}
          </button>
        </div>
      </div>
              ...
              <>
                ...
                >
                  ...
                  <span style={{ fontSize: 11, fontWeight: 600, color: 'white' }}>
                    {localSpeaker === 'DOCTOR' ? 'Patient' : 'Doctor'}
                  </span>
                </div>
              </>
            )}
          ...
          {(isPaused || isRemotePaused) && (
            ...
            >
              ...
              {isPaused && (
                ...
                >
                  <Play style={{ width: 10, height: 10, display: 'inline', marginRight: 4 }} />
                  Resume
                </button>
              )}
            </div>
          ...
          {!video?.isConnected && (
            ...
            >
              ...
              <p style={{ fontSize: 12, color: '#94A3B8', margin: 0 }}>
                Connecting to secure video channel...
              </p>
            </div>
          )}
        ...
        {patientJoinLink && localSpeaker === 'DOCTOR' && (
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: 12, fontWeight: 600, color: '#4338CA', margin: '2px 0 0' }}>
                Invite Call Link
              </p>
            </div>
            <button
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                height: 32,
                borderRadius: '50%',
                border: `1.5px solid ${video?.isMicOn ? '#C7D2FE' : '#FCA5A5'}`,
                background: video?.isMicOn ? '#EEF2FF' : '#FEF2F2',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
            ...
            >
              {video?.isMicOn ? (
                <Mic style={{ width: 13, height: 13, color: '#6366F1' }} />
              ) : (
            ...
            <button
              ...
              style={{
                ...
                height: 32,
                borderRadius: '50%',
                border: `1.5px solid ${video?.isCameraOn ? '#C7D2FE' : '#FCA5A5'}`,
                background: video?.isCameraOn ? '#EEF2FF' : '#FEF2F2',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
            ...
            >
              {video?.isCameraOn ? (
                <Video style={{ width: 13, height: 13, color: '#6366F1' }} />
              ) : (
                <VideoOff style={{ width: 13, height: 13, color: '#EF4444' }} />
              )}
            </button>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              {transcript
                ...
                .map((seg, idx) => (
                  <div
                    key={`${seg.speaker}-${seg.sequenceNumber}-${idx}`}
            ...
            {transcriptBottomActions && (
              <div
                style={{ padding: '0.625rem 1rem', borderTop: '1px solid #F3F4F6', flexShrink: 0 }}
              >
                {transcriptBottomActions}
              </div>
            )}
