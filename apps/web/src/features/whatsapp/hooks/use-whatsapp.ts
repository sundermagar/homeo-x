...
export const useWhatsApp = () => {
  ...
  return {
    ...
    useCreateChannel: () =>
      useMutation({
        mutationFn: async (payload: any) => {
          const { data } = await apiClient.post<{ data: WhatsAppChannel }>(
            '/whatsapp/channels',
            payload,
          );
          return data.data;
      ...
      useQuery({
        ...
        queryFn: async () => {
          const { data } = await apiClient.get<{
            data: WhatsAppCampaign[] | { data: WhatsAppCampaign[] };
          }>('/whatsapp/campaigns');
    ...
    useCreateCampaign: () =>
      useMutation({
        mutationFn: async (payload: any) => {
          const { data } = await apiClient.post<{ data: WhatsAppCampaign }>(
            '/whatsapp/campaigns',
            payload,
          );
          return data.data;
      ...
      useMutation({
        mutationFn: async (campaignId: number) => {
          const { data } = await apiClient.post<{ data: any }>(
            `/whatsapp/campaigns/${campaignId}/broadcast`,
          );
          return data.data;
        },
        onSuccess: () => {
    ...
    useDeleteCampaign: () =>
      useMutation({
        mutationFn: async (campaignId: number) => {
          const { data } = await apiClient.delete<{ data: any }>(
    ...
    useSyncTemplates: () =>
      useMutation({
        mutationFn: async (channelId: number) => {
          const { data } = await apiClient.post<{ data: any }>('/whatsapp/templates/sync', {
            channelId,
          });
          return data.data;
        },
      ...
      useMutation({
        ...
        onSuccess: (_, variables) => {
          queryClient.invalidateQueries({
            queryKey: ['whatsapp', 'templates', variables.channelId],
          });
        },
      }),
    useUpdateTemplate: () =>
    ...
    useDeleteTemplate: (channelId?: number) =>
      useMutation({
    ...
    useUpdateConversationStatus: () =>
      useMutation({
        mutationFn: async ({
          ...
          const { data } = await apiClient.patch<{ data: any }>(`/whatsapp/conversations/${id}`, {
            status,
            tags,
            priority,
          });
    ...
    useConversations: (channelId?: number) =>
      useQuery({
        queryKey: ['whatsapp', 'conversations', channelId],
        queryFn: async () => {
          if (!channelId) return [] as WhatsAppConversation[];
          const { data } = await apiClient.get<{ data: WhatsAppConversation[] }>(
    ...
    useCreateConversation: () =>
      useMutation({
        mutationFn: async (payload: {
          ...
          const { data } = await apiClient.post<{ data: WhatsAppConversation }>(
            '/whatsapp/conversations',
            payload,
          );
          return data.data;
        ...
        onSuccess: (_, variables) => {
          queryClient.invalidateQueries({
            queryKey: ['whatsapp', 'conversations', variables.channelId],
          });
        },
      }),
    useMessages: (conversationId?: number) =>
      useQuery({
        ...
        queryFn: async () => {
          ...
          const { data } = await apiClient.get<{ data: WhatsAppMessage[] }>(
    ...
    useSendMessage: () =>
      useMutation({
        mutationFn: async ({
          ...
          const { data } = await apiClient.post<{ data: WhatsAppMessage }>(
            `/whatsapp/conversations/${conversationId}/messages`,
            {
              content,
              mediaId,
        ...
        onMutate: async ({ conversationId, content, mediaId, mediaType, fileName }) => {
          ...
          const previousMessages =
            queryClient.getQueryData<WhatsAppMessage[]>(['whatsapp', 'messages', conversationId]) ||
            [];
    ...
    useSendReaction: () =>
      useMutation({
        mutationFn: async ({ messageId, emoji }: { messageId: number; emoji: string }) => {
          const { data } = await apiClient.post<{ data: any }>(
            `/whatsapp/messages/${messageId}/reaction`,
            { emoji },
          );
          return data.data;
        },
    ...
    useUploadMedia: () =>
      useMutation({
        mutationFn: async ({
          ...
          formData.append('file', file);
          const { data } = await apiClient.post<{ data: { mediaId: string } }>(
    ...
    // Contacts
    useContacts: (clinicId?: number) =>
      useQuery({
        queryKey: ['wa-contacts', clinicId],
        queryFn: async () => {
          const { data } = await apiClient.get<{ data: any[] | { data: any[] } }>(
            '/whatsapp/contacts',
          );
          const d = data.data;
    ...
    // Automations
    useAutomations: (clinicId?: number) =>
      useQuery({
    ...
    useSendTemplate: () =>
      useMutation({
        ...
        onSuccess: (_, vars) => {
          queryClient.invalidateQueries({
            queryKey: ['whatsapp', 'messages', vars.conversationId],
          });
          queryClient.invalidateQueries({ queryKey: ['whatsapp', 'conversations'] });
        },
      }),
    ...
    useDefaultChannel: () =>
      useQuery({
        ...
        queryFn: async () => {
          const { data } = await apiClient.get<{
            data: { configured: boolean; channel: WhatsAppChannel | null };
    ...
    useAiSettings: (channelId: number | null) =>
      useQuery({
    ...
    useSaveAiSettings: () =>
      useMutation({
        mutationFn: async (payload: { channelId: number; data: any }) => {
          const { data } = await apiClient.put<{ data: any }>(
            `/whatsapp/ai-settings/${payload.channelId}`,
            payload.data,
          );
          return data.data;
        },
    ...
    useSaveWidgetSettings: () =>
      useMutation({
        mutationFn: async (payload: { channelId: number; data: any }) => {
          const { data } = await apiClient.put<{ data: any }>(
            `/whatsapp/widget-settings/${payload.channelId}`,
            payload.data,
          );
          return data.data;
        },
        onSuccess: (_, vars) => {
          queryClient.invalidateQueries({
            queryKey: ['whatsapp', 'widget-settings', vars.channelId],
          });
        },
      }),

    useTrainingSources: (channelId: number | null) =>
      useQuery({
        queryKey: ['whatsapp', 'training-sources', channelId],
        queryFn: async () => {
          if (!channelId) return [];
          const { data } = await apiClient.get<{ data: any[] }>(
            `/whatsapp/training/sources/${channelId}`,
          );
          return data.data;
        },
        enabled: !!channelId,
    ...
    useAddTrainingSource: () =>
      useMutation({
        ...
        onSuccess: (_, vars) => {
          queryClient.invalidateQueries({
            queryKey: ['whatsapp', 'training-sources', vars.channelId],
          });
        },
      }),
    ...
    useUploadTrainingFile: () =>
      useMutation({
        ...
        onSuccess: (_, vars) => {
          ...
          queryClient.invalidateQueries({
            queryKey: ['whatsapp', 'training-stats', vars.channelId],
          });
        },
      }),

    useTrainingPreview: (channelId: number | null) =>
      useQuery({
        queryKey: ['whatsapp', 'training-preview', channelId],
        queryFn: async () => {
          if (!channelId) return { qaPairs: [], sourcesWithChunks: [] };
          const { data } = await apiClient.get<{ data: any }>(
            `/whatsapp/training/preview/${channelId}`,
          );
          return data.data;
        },
        enabled: !!channelId,
    ...
    useProcessTrainingSource: () =>
      useMutation({
        mutationFn: async (id: number) => {
          const { data } = await apiClient.post<{ data: any }>(
            `/whatsapp/training/sources/${id}/process`,
          );
          return data.data;
        },
        onSuccess: () => {
    ...
    useTrainingQaPairs: (channelId: number | null) =>
      useQuery({
        queryKey: ['whatsapp', 'training-qa', channelId],
        queryFn: async () => {
          if (!channelId) return [];
          const { data } = await apiClient.get<{ data: any[] }>(
            `/whatsapp/training/qa/${channelId}`,
          );
          return data.data;
        },
        enabled: !!channelId,
    ...
    useTrainingStats: (channelId: number | null) =>
      useQuery({
        queryKey: ['whatsapp', 'training-stats', channelId],
        queryFn: async () => {
          if (!channelId) return null;
          const { data } = await apiClient.get<{ data: any }>(
            `/whatsapp/training/stats/${channelId}`,
          );
          return data.data;
        },
        enabled: !!channelId,
    ...
    // Campaigns Paginated
    useCampaignsPaginated: (params: { page: number; limit: number; search?: string }) =>
      useQuery({
        queryKey: ['whatsapp', 'campaigns', params],
        queryFn: async () => {
          const { data } = await apiClient.get<{
            data: { data: WhatsAppCampaign[]; total: number };
          }>('/whatsapp/campaigns', { params });
          return data.data;
        },
        staleTime: 30_000,
      }),
    // Contacts Paginated
    useContactsPaginated: (params: { page: number; limit: number; search?: string }) =>
      useQuery({
        queryKey: ['whatsapp', 'contacts', params],
        queryFn: async () => {
          const { data } = await apiClient.get<{ data: { data: any[]; total: number } }>(
            '/whatsapp/contacts',
            { params },
          );
          return data.data;
    ...
    // Media Paginated
    useMediaPaginated: (params: { page: number; limit: number; search?: string }) =>
      useQuery({
    ...
    // Chatbots Paginated
    useChatbotsPaginated: (params: { page: number; limit: number; search?: string }) =>
      useQuery({
    ...
    useAutomationsPaginated: (params: { page: number; limit: number; search?: string }) =>
      useQuery({
