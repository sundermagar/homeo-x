            ...
            >
                    ...
                    <>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs opacity-90 text-white">{config.subtitle}</p>
                        </div>
                      </div>
                      <button
                        ...
                        >
                          ...
                          <div
                            className={`rounded-2xl px-3 py-2 max-w-[80%] text-xs ${
                              msg.role === 'user'
                                ? 'text-white'
                                : 'bg-[var(--bg-main)] text-main border border-pp-border/50'
                            }`}
                            style={
                              msg.role === 'user' ? { backgroundColor: config.primaryColor } : {}
                            }
                          >
              ...
              {config.showPoweredBy && (
                <div className="p-2 border-t text-center bg-[var(--bg-main)] pointer-events-none select-none">
                  <p className="text-[9px] text-slate-400">Powered by {config.appName}</p>
                </div>
              )}
            </div>
          )}
                ...
                background:
                  config.buttonStyle === 'gradient'
                    ...
                    : config.buttonStyle === 'outline'
                      ...
                      : config.primaryColor,
                border:
                  config.buttonStyle === 'outline' ? `2.5px solid ${config.primaryColor}` : 'none',
