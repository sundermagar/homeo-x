...
export function ConfigPanel({
      ...
      <div className="h-full flex flex-col justify-center px-6 py-8 overflow-y-auto bg-gradient-to-b from-white to-gray-50/50">
        <div className="flex flex-col items-center text-center mb-8">
          <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/10 to-indigo-500/10 flex items-center justify-center mb-4 border border-blue-100/50 shadow-sm animate-pulse">
            <Settings2 className="w-7 h-7 text-blue-600 animate-spin-slow" style={{ animationDuration: '8s' }} />
        ...
        <div className="space-y-3 pt-6 border-t border-gray-100">
          ...
          <div className="flex gap-3 p-3 rounded-xl border border-gray-100 bg-[var(--bg-card)] shadow-sm hover:shadow transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-[9px] text-gray-400 mt-0.5 leading-normal font-medium">Click buttons in the left panel to inject text replies, catalogs, or media.</p>
            </div>
          </div>
          ...
          <div className="flex gap-3 p-3 rounded-xl border border-gray-100 bg-[var(--bg-card)] shadow-sm hover:shadow transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-[9px] text-gray-400 mt-0.5 leading-normal font-medium">Drag connections from condition nodes to route users based on keyword matches.</p>
            </div>
          </div>
          ...
          <div className="flex gap-3 p-3 rounded-xl border border-gray-100 bg-[var(--bg-card)] shadow-sm hover:shadow transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-[9px] text-gray-400 mt-0.5 leading-normal font-medium">Use delays to space out messages perfectly matching natural human conversation speeds.</p>
            </div>
          </div>
          ...
          <div className="flex gap-3 p-3 rounded-xl border border-gray-100 bg-[var(--bg-card)] shadow-sm hover:shadow transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-[9px] text-gray-400 mt-0.5 leading-normal font-medium">Query APIs or sync external CRM data databases in real-time during conversations.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const updateButton = (buttonId: string, updates: any) => {
    onChange({ buttons: ((d['buttons'] || []) as any[]).map((btn) => (btn.id === buttonId ? { ...btn, ...updates } : btn)) });
  };
  ...
  const removeListSection = (sectionIdx: number) => {
    onChange({ listSections: ((d['listSections'] || []) as ListSection[]).filter((_, i) => i !== sectionIdx) });
  };
                          ...
                          onChange={async (e) => {
                            ...
                            try {
                              ...
                              if (data.success && data.mediaId) {
                                ...
                                toast({ title: "Upload failed", description: data.message || "Please try again", variant: "error" });
                              }
                            } catch {
