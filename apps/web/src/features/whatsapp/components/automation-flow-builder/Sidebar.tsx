      ...
      <div className="w-[260px] shrink-0 h-full bg-gradient-to-b from-white to-gray-50/30 flex flex-col border-r border-gray-100 overflow-hidden z-10">
        <div className="px-3.5 py-3 border-b border-gray-100 bg-gradient-to-r from-gray-50/50 to-white shrink-0">
          ...
          <div className="text-[10px] text-gray-400 mt-0.5 flex items-center gap-1 font-medium">
            ...
            <span>
              hover <Info className="w-2.5 h-2.5 inline" /> for help
            </span>
          </div>
        </div>
                ...
                {category.items.map((item) => {
                  ...
                  return (
                    <div key={item.kind} className="relative">
                      ...
                      >
                        <Icon
                          className={`w-5 h-5 ${item.color} transition-transform duration-300 ease-out group-hover:scale-110 group-hover:rotate-3`}
                        />
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent
                          side="right"
                          className="max-w-[220px] text-xs leading-relaxed p-3 shadow-md border border-gray-100 bg-[var(--bg-card)] text-gray-700"
                        >
                          <p className="font-bold text-gray-900 mb-1 flex items-center gap-1">
                            <span
                              className={`w-1.5 h-1.5 rounded-full ${item.bg}`}
                              style={{
                                border: `1px solid ${item.color.replace('text-', 'var(--')}`,
                              }}
                            />
                            {item.name}
                          </p>
