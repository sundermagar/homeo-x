      ...
      <div className="pp-page-hero">
        <div>
          ...
          <p className="pp-page-hero-sub">
            Patient cases, longitudinal records, and clinical findings.
          </p>
        </div>
                  ...
                  <tr>
                    <td colSpan={5}>
                      <EmptyState
                        ...
                        description={
                          search
                            ? `We couldn't find any clinical case matching "${search}".`
                            : 'Your clinical registry is currently empty. Cases will appear here as patients are registered and visits are recorded.'
                        }
                    ...
                    >
                      ...
                      <td data-label="Status">
                        <div className="mc-status-cell">
                          <div className="mc-status-row">
                            <span
                              className={`mc-status-dot ${record.status !== 'Active' ? 'inactive' : ''}`}
                            />
                      ...
                      <td data-label="Last Visit">
                        <div className="mc-visit-cell">
                          ...
                          <div>
                            <div className="mc-visit-date">
                              {record.last_followup || 'No visits yet'}
                            </div>
          ...
          {isLoading ? (
            ...
            <div style={{ gridColumn: '1/-1' }}>
              <EmptyState
                ...
                description={
                  search
                    ? `No records matching "${search}" were found.`
                    : 'The clinical registry is currently empty.'
                }
                actionLabel={search ? 'Clear Search' : 'New Case'}
                onAction={search ? () => setSearch('') : () => navigate('/patients/new')}
                variant="card"
            ...
            records.data.map((record: any) => (
              ...
              >
                ...
                <div style={{ display: 'grid', gap: 8, color: '#334155', fontSize: 13 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                    <Activity size={13} />
                    {record.bp ? record.bp : 'No BP data'}
                  </div>
                </div>
                <div
                  style={{
                ...
                >
                  <span
                    style={{
                      color:
                        record.status !== 'Active' ? 'var(--pp-danger-fg)' : 'var(--pp-success-fg)',
                      fontWeight: 700,
                    }}
                  >
