...
export function VitalsFormModal({
  visitId,
  regid,
  initialData,
  onClose,
  onSuccess,
}: VitalsFormModalProps) {
  ...
  const handleUnitToggle = (type: 'weight' | 'height') => {
    if (type === 'weight') {
      ...
      if (current) {
        const next =
          weightUnit === 'kg' ? (current * 2.20462).toFixed(1) : (current / 2.20462).toFixed(1);
      ...
      if (current) {
        const next =
          heightUnit === 'cm' ? (current / 2.54).toFixed(1) : (current * 2.54).toFixed(1);
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <div style={{ fontSize: '0.95rem', fontWeight: 700, color: 'var(--pp-ink)' }}>
                Visit ID: #{visitId}
              </div>
            </div>
        ...
        >
          <div style={{ padding: '24px', flex: 1, overflowY: 'auto' }}>
            ...
            <div style={{ marginBottom: '28px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  ...
                  >
                    <label
                      style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--pp-text-2)' }}
                    >
                      Weight
                    </label>
                    <button
            ...
            <div style={{ marginBottom: '28px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                <label style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--pp-text-2)' }}>
