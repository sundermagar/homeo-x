...
import { Plus, Search, Edit2, Trash2, X, ClipboardList, Mail, Phone, MapPin, Users, UserCheck, Calendar, Briefcase, Info, BadgeIndianRupee, RefreshCw } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="plat-modal-body">
          ...
          <div className="plat-form-grid">
            ...
            <div className="plat-form-group">
              ...
              <input type="text" className="plat-form-input" value={form.name || ''} onChange={(e) => updateForm('name', e.target.value)} disabled={isLoading} />
              {errors['name'] && <span className="plat-form-error">{errors['name']}</span>}
            </div>

            <div className="plat-form-group">
              <label className="plat-form-label">Email Address</label>
              <input type="email" className="plat-form-input" value={form.email || ''} onChange={(e) => updateForm('email', e.target.value)} disabled={isLoading} placeholder="staff@clinic.com" />
            </div>
            ...
            <div className="plat-form-group">
              ...
              <input type="text" className="plat-form-input" value={form.designation || ''} onChange={(e) => updateForm('designation', e.target.value)} disabled={isLoading} placeholder="e.g. Front Desk Officer" />
            </div>
            ...
            {mode === 'edit' && (
              <div className="plat-form-group">
                <label className="plat-form-label">Date Left Service</label>
    ...
    <div className="plat-page">
      ...
      <div className="plat-card">
        {isLoading ? (
          ...
          <div className="plat-empty"><ClipboardList size={40} className="plat-empty-icon" /><p className="plat-empty-text">No receptionist records found.</p></div>
        ) : (
