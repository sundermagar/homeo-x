...
export default function DoctorDetailPage() {
        ...
        >
          <div
            style={{
              width: 40,
              height: 40,
              border: '4px solid var(--pp-blue-tint)',
              borderTopColor: 'var(--pp-blue)',
              borderRadius: '50%',
  ...
  if (error || !staff) {
    return (
      <div
        className="plat-profile-page flex items-center justify-center"
        style={{ padding: '32px' }}
      >
        <div
          className="plat-profile-card"
          style={{ maxWidth: 500, margin: '0 auto', textAlign: 'center', padding: '48px' }}
        >
          <div
            style={{
              width: 64,
              height: 64,
              backgroundColor: 'var(--pp-danger-bg)',
          ...
          <h2 style={{ fontSize: 20, fontWeight: 900, color: 'var(--pp-ink)', marginBottom: 12 }}>
            Record Restricted
          </h2>
      ...
      <div className="plat-doc-item" key={label}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span className="plat-profile-label" style={{ marginBottom: 0 }}>
              Verified Record
            </span>
            <span
              style={{
        ...
        <a
          ...
          style={{
            ...
            backgroundColor: 'var(--pp-blue-tint)',
          }}
        >
  ...
  return (
    <div className="plat-profile-page animate-fade-in">
      ...
      <div className="plat-profile-header">
        <div
          className="plat-profile-container"
          style={{
            display: 'flex',
            flexWrap: 'wrap',
            alignItems: 'center',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              >
                Practitioner{' '}
                <span style={{ color: 'var(--pp-blue)', fontFamily: 'var(--pp-font-mono)' }}>
            ...
            >
              <span
                style={{
                  ...
                  height: 6,
                  borderRadius: '50%',
                  background: staff.isActive ? 'var(--pp-success-fg)' : 'var(--pp-text-4)',
                  boxShadow: staff.isActive ? '0 0 8px var(--pp-success-fg)' : 'none',
                }}
              />
              <span
                style={{
      ...
      <main className="plat-profile-container">
        <div className="plat-grid">
          ...
          <aside
            className="plat-sidebar"
            style={{ display: 'flex', flexDirection: 'column', gap: 24 }}
          >
            <div
              className="plat-profile-card text-center"
            ...
            >
              <div
                style={{
                  ...
                  right: 0,
                  height: 80,
                  background: 'linear-gradient(to bottom, var(--pp-blue-tint), transparent)',
                }}
              />

              <div style={{ display: 'inline-block', position: 'relative', marginBottom: 24 }}>
                <div
                  className="anim-float-avatar"
                  style={{
                    width: 120,
                    height: 120,
                    borderRadius: '50%',
              ...
              <h1
                className="plat-profile-title plat-capitalize"
                style={{ marginBottom: 8, position: 'relative', zIndex: 10 }}
              >
              ...
              >
                ...
                >
                  {staff.designation || 'Practitioner'}
                </span>
              </div>
              ...
              >
                ...
                >
                  ...
                  <p
                    className="plat-profile-value plat-profile-mono text-title"
                    style={{ color: 'var(--pp-blue-deep)' }}
                  >
                    ₹{staff.consultationFee || '0'}
                  </p>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <p
                    className="plat-profile-value text-title"
                    style={{ color: 'var(--pp-blue-deep)' }}
                  >
                    {staff.joiningdate ? new Date(staff.joiningdate).getFullYear() : 'New'}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div
                  style={{
                    ...
                    background: 'var(--pp-warm-1)',
                    borderRadius: 8,
                    borderLeft: '3px solid var(--pp-blue)',
                  }}
                >
                ...
                <div style={{ padding: '0 4px' }}>
                  ...
                  <p style={{ fontSize: 13, fontWeight: 700, color: 'var(--pp-ink)' }}>
                    {staff.email}
                  </p>
                </div>
                <div style={{ padding: '0 4px' }}>
                  ...
                  <p
                    ...
                    className="plat-capitalize"
                  >
                    <MapPin size={12} fill="var(--pp-danger-bg)" color="var(--pp-danger-fg)" />{' '}
                    {staff.city || 'Regional Hub'}
                  </p>
                </div>
              </div>
            </div>
          ...
          >
              ...
              <div className="plat-profile-card">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  >
                    ...
                    <p
                      style={{ fontSize: 14, fontWeight: 800, color: 'var(--pp-ink)' }}
                      className="plat-capitalize"
                    >
                      {staff.qualification || 'Medical Graduate'}
                    </p>
                  </div>
                  <div style={{ padding: '0 4px' }}>
                    <span className="plat-profile-label">Alma Mater / University</span>
                    <p
                      style={{ fontSize: 13, fontWeight: 700, color: 'var(--pp-ink)' }}
                      className="plat-capitalize"
                    >
                      {staff.institute || 'Verified Institution'}
                    </p>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      REG: {staff.registrationId || 'PENDING'}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="plat-profile-card">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  >
                    ...
                    >
                      {staff.aadharnumber || 'NOT RECORDED'}
                    </p>
                  </div>
                  <div
                    style={{
            ...
            <div className="plat-profile-card">
              ...
              >
                ...
                <div
                  style={{
                    padding: 16,
                    border: '1px dashed var(--pp-warm-4)',
                    borderRadius: 'var(--pp-radius-lg)',
                  }}
                >
            ...
            <div
              className="plat-profile-card"
              style={{
                background: 'linear-gradient(to right, var(--pp-blue-deep), var(--pp-blue))',
                color: 'white',
                position: 'relative',
                overflow: 'hidden',
              }}
            >
              ...
              <h3
                className="plat-profile-section-title"
              ...
              >
                {staff.about ||
                  'A professional practitioner summary is currently being prepared for this clinical record. All academic and institutional credentials have been digitally verified for regulatory compliance within the platform.'}
              </p>
            </div>
          </section>
        </div>
