...
import { Plus, Search, Edit2, Trash2, X, UserCog, Mail, Phone, MapPin, Users, UserCheck, Calendar, Briefcase, Info, BadgeIndianRupee, RefreshCw } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="plat-modal-body">
          ...
          <div className="plat-form-grid">
            ...
            <div className="plat-form-group">
              ...
              <input type="text" className="plat-form-input" value={form.name || ''} onChange={(e) => updateForm('name', e.target.value)} disabled={isLoading} placeholder="e.g. John Smith" />
              {errors['name'] && <span className="plat-form-error">{errors['name']}</span>}
            </div>

            <div className="plat-form-group">
              <label className="plat-form-label">Work Email</label>
              <input type="email" className="plat-form-input" value={form.email || ''} onChange={(e) => updateForm('email', e.target.value)} disabled={isLoading} placeholder="accounts@clinic.com" />
            </div>
            ...
            <div className="plat-form-group">
              ...
              <input type="text" className="plat-form-input" value={form.designation || ''} onChange={(e) => updateForm('designation', e.target.value)} disabled={isLoading} placeholder="e.g. Senior Accountant" />
            </div>
            ...
            <div className="plat-form-group">
              <label className="plat-form-label">Assigned Station / City</label>
            ...
            {mode === 'create' && (
              <div className="plat-form-group">
                <label className="plat-form-label">Access Credential: Set Password *</label>
                <input
                  type="password"
            ...
            {mode === 'edit' && (
              <div className="plat-form-group">
                <label className="plat-form-label">Service Termination Date</label>
          ...
          <div className="plat-modal-footer">
            ...
            <button type="submit" className="plat-btn plat-btn-primary" disabled={isPending || isLoading}>
              {isPending ? 'Updating Ledgers…' : isEdit ? 'Update Profile' : 'Register Manager'}
            </button>
          </div>
        </form>
      </div>
    ...
    <div className="plat-page">
      ...
      <div className="plat-card">
        {isLoading ? (
          ...
          <div className="plat-empty"><UserCog size={40} className="plat-empty-icon" /><p className="plat-empty-text">No account managers found.</p></div>
        ) : (
