    ...
    <div className="pp-page-container comm-page animate-fade-in">
      ...
      <div className="comm-two-col">
        ...
        <div className="pp-table-container-enhanced" style={{ padding: '24px' }}>
          ...
          >
            <h2 className="comm-card-title" style={{ fontSize: '1rem' }}>
          ...
          <div className="comm-card-body">
            ...
            <div className="comm-composer">
              ...
              <div className="comm-form-group">
                ...
                />
                <div className="comm-char-count">{charCount} characters</div>
              </div>

              <div className="comm-placeholder-hint">
                Placeholders: <code>{'{#name#}'}</code> Patient name · <code>{'{#date#}'}</code>{' '}
                Today
              </div>
                ...
                >
                  {waSingle.isPending || waBroadcast.isPending ? (
                    ...
                    <>
                      ...
                      {mode === 'single' ? 'Send WhatsApp' : 'Broadcast via WhatsApp'}
                    </>
                  )}
                </button>
              </div>
        ...
        <div className="comm-info-col">
          <div className="pp-table-container-enhanced" style={{ padding: '24px' }}>
            ...
            <div className="comm-card-body">
              <div className="comm-info-text">
                <p>
                  <strong>Meta Compliance:</strong> For initial outbound messages, ensure you are
                  using approved templates to avoid being flagged.
                </p>
                <p>
                  <strong>Placeholders:</strong> Use <code>{'{#name#}'}</code> to personalize
                  messages. Personalization increases patient engagement.
                </p>
                <p>
                  <strong>E2E Encryption:</strong> All messages sent through Homeo-X are secured
                  using Meta&apos;s end-to-end encryption pipeline.
                </p>
              </div>
            </div>
          </div>
          <div className="comm-placeholder-card" style={{ borderColor: '#25D366' }}>
            ...
            <div className="comm-placeholder-text">
              Legacy SMS messaging has been deactivated. All clinical correspondence is now routed
              through the Meta Verified WhatsApp Cloud API.
            </div>
          </div>
        </div>
      </div>
