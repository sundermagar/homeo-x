...
export default function BirthdayBroadcastPage() {
  ...
  const [message, setMessage] = useState(
    'Happy Birthday! Wishing you a day filled with happiness and a year filled with joy. Regards, Homoeo Home Clinic.',
  );
  ...
  const handleBroadcast = async () => {
    ...
    if (!phones.length) {
      toast({
        ...
        description: 'None of the selected patients have a phone number.',
        variant: 'error',
      });
      return;
    }
      ...
      <div className="pp-page-hero">
        <div>
          ...
          <p className="pp-page-hero-sub">
            Send personalized greetings to patients celebrating today (
          ...
          <div className="pp-stat-card-enhanced" style={{ padding: 24 }}>
            ...
            >
              <p style={{ fontSize: 12, color: 'var(--pp-blue)', lineHeight: 1.6 }}>
                <strong>Pro Tip:</strong> Keeping messages warm and personal improves patient
                loyalty and clinical engagement.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ gridColumn: 'span 2' }}>
          <div className="pp-table-container-enhanced">
            ...
            <div style={{ maxHeight: 500, overflowY: 'auto' }}>
              {loading ? (
                <div style={{ padding: 80, textAlign: 'center', color: 'var(--pp-text-3)' }}>
                  Loading birthdays...
                </div>
              ) : patients.length === 0 ? (
                  ...
                  <tbody>
                    {patients.map((p) => (
                      ...
                      >
                        ...
                        <td data-label="Mobile" style={{ fontSize: 13, color: 'var(--pp-text-2)' }}>
                          {p.phone || p.mobile1 || '—'}
                        </td>
