...
export function RolesPermissionsPage() {
  ...
  const handleDeleteRole = async (id: number) => {
    if (
      window.confirm(
        'Delete this organizational role? This will revoke access for all members currently assigned to it.',
      )
    ) {
  ...
  const handleDeletePerm = async (id: number) => {
    if (
      window.confirm(
        'Delete this system capability? This will remove it from ALL roles and potentially break application logic.',
      )
    ) {
    ...
    <div className="plat-page fade-in">
      <div className="plat-header">
        <div className="plat-header-left">
          ...
          <p className="plat-header-sub">
            Define organizational hierarchies and cross-module capability nodes.
          </p>
        </div>
      ...
      <div className="plat-stats-bar">
        ...
        <div className="plat-stat-card">
          ...
          <div className="flex items-center justify-between">
            <p className="plat-stat-value plat-stat-value-secondary" style={{ color: '#d97706' }}>
                ...
                filteredRoles.map((role) => (
                  ...
                  >
                    ...
                    <div className="plat-role-info">
                      ...
                      <div className="plat-role-desc">
                        {role.description || 'No description provided'}
                      </div>
                    </div>
                    <div className="flex gap-1 md:opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        className="plat-btn plat-btn-icon plat-btn-ghost plat-btn-sm"
                        onClick={(e) => {
                          e.stopPropagation();
                          setEditRole(role);
                          setRoleModalOpen(true);
                      ...
                      <button
                        className="plat-btn plat-btn-icon plat-btn-ghost-danger plat-btn-sm"
                        onClick={(e) => {
                          e.stopPropagation();
              ...
              {loadingSelectedRole ? (
                ...
                <div className="plat-matrix-empty">
                  ...
                  <div>
                    ...
                    <p className="text-sm color-muted px-8">
                      Pick a role from the list to manage its module-level permissions.
                    </p>
                  </div>
                </div>
              ) : (
                          ...
                          return (
                            <tr key={perm.id}>
                              <td>
                                ...
                                <div className="plat-cap-desc">
                                  {perm.description ||
                                    `Grants access to ${perm.name} functionality.`}
                                </div>
                              </td>
        ...
        <div className="plat-card shadow-premium">
          <div className="plat-card-header">
            <div className="plat-header-left">
              ...
              <p className="plat-header-sub">
                System-wide definition of permission nodes available to the RBAC engine.
              </p>
            </div>
            <button
              className="plat-btn plat-btn-primary"
                  ...
                  allPermissions.map((perm) => (
                    <tr key={perm.id} className="plat-table-row">
                      <td>
                        ...
                        <div className="plat-cap-desc line-clamp-1">
                          {perm.description || 'Global system node.'}
                        </div>
                        {/* Mobile only identifier */}
                        <div className="md:hidden mt-1">
                          <code className="text-[9px] bg-slate-100 px-1 rounded text-slate-500 uppercase">
                            {perm.slug || 'AUTO_GEN'}
                          </code>
                        </div>
                      </td>
                      <td className="hidden md:table-cell">
                        <code className="plat-badge plat-badge-default font-mono text-[11px]">
                          {perm.slug || 'AUTO_GEN'}
                        </code>
                      </td>
                      <td>
                      ...
                      <td className="text-right">
                        <div className="flex gap-1 justify-end">
                          ...
                          <button
                            className="plat-btn-icon plat-btn-ghost-danger plat-btn-sm"
                ...
                <div className="plat-form-grid-multi" style={{ gridTemplateColumns: '1fr' }}>
                  ...
                  <div className="plat-form-group">
                    ...
                    <textarea
                      ...
                      placeholder="What capabilities does this role typically perform?"
                    />
                  </div>
                </div>
              </div>
          ...
          >
              ...
              <div className="plat-form-section">
                <div className="plat-form-grid-multi" style={{ gridTemplateColumns: '1fr' }}>
                  <div className="plat-form-group">
                    ...
                    <input
                      name="name"
                      defaultValue={editPerm?.name}
                      required
                      className="plat-form-input"
                      placeholder="e.g. Patients View Only"
                    />
                  </div>
                  <div className="plat-form-group">
                    ...
                    <select
                      name="module"
                      defaultValue={editPerm?.module || 'CORE'}
                      className="plat-form-input"
                    >
                  ...
                  <div className="plat-form-group">
                    ...
                    <textarea
                      name="description"
                      defaultValue={editPerm?.description}
                      className="plat-form-input"
                      style={{ minHeight: '80px' }}
                      placeholder="What specific access does this node grant?"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="plat-modal-footer">
              ...
              <button
                type="submit"
                className="plat-btn plat-btn-primary"
                disabled={createPerm.isPending || updatePerm.isPending}
              >
