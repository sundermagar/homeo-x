...
export default function ReferralSourcesPage() {
  ...
  const filteredItems = referrals.filter(
    (r: any) =>
      ...
      <div className="plat-header">
        <div>
          ...
          <p className="plat-header-sub">
            Manage where your patients are coming from (Doctors, Marketing, etc.).
          </p>
        </div>
      ...
      <div className="plat-card">
        {isLoading ? (
          ...
          <EmptyState
            ...
            description={
              searchQuery
                ? `No sources matching "${searchQuery}" were found.`
                : 'Track patient acquisition by adding your first referral source.'
            }
                ...
                <tbody>
                  {paginatedData.map((ref: any, idx: number) => (
                    <tr key={ref.id} className="plat-table-row">
                      ...
                      <td data-label="Source Name" className="plat-table-cell font-semibold">
                        {ref.name}
                      </td>
                      ...
                      <td data-label="Status" className="plat-table-cell">
                        <span
                          className={`plat-badge ${ref.isActive ? 'plat-badge-staff' : 'plat-badge-default'}`}
                        >
        ...
        <form onSubmit={handleSubmit}>
            ...
            >
              <div className="plat-form-grid-multi" style={{ gridTemplateColumns: '1fr' }}>
                ...
                <label className="plat-checkbox-group">
                  ...
                  />
                  <span className="plat-checkbox-label">Source is actively used</span>
                </label>
              </div>
            </div>
          </div>
          <div className="plat-modal-footer" style={{ padding: '24px 0 0 0', marginTop: '24px' }}>
            ...
            <button
              ...
              disabled={createRef.isPending || updateRef.isPending}
            >
