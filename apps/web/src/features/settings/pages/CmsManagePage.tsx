      ...
      <div className="plat-header">
        <div>
          ...
          <p className="plat-header-sub">
            Manage clinical website content, privacy policies, and public documents.
          </p>
        </div>
      ...
      <div className="plat-card">
        {isLoading ? (
          ...
          <EmptyState
            ...
            description={
              search
                ? `No pages matching "${search}" were found.`
                : 'Start managing your clinical website content by adding your first static page.'
            }
                    ...
                    <tr key={page.id} className="plat-table-row">
                      ...
                      <td data-label="Title" className="plat-table-cell">
                        <div className="plat-cell-val">
                          ...
                          <div className="text-xs color-muted mt-0.5">
                        ...
                        <div className="plat-cell-val">
                          <div className="flex justify-end gap-3" style={{ width: '100%' }}>
                            ...
                            <button
                              ...
                              style={{ width: 36, height: 36, borderRadius: 10 }}
                              onClick={() => {
                                if (confirm(`Archive page "${page.title}"?`))
            ...
            >
              ...
              <div className="plat-form-group mt-6">
                <label className="plat-form-label font-bold flex justify-between">
                  ...
                  <span className="text-[10px] uppercase tracking-wider text-muted font-bold opacity-60">
                    Rich Editor
                  </span>
                </label>
                <textarea
              ...
              <div className="flex items-center gap-2 py-4 mt-2">
                ...
                <div>
                  <label
                    htmlFor="page_active_cms"
                    className="plat-form-label cursor-pointer mb-0 font-bold"
                  >
                    Publish this page
                  </label>
                  <p className="text-[10px] text-muted -mt-0.5">
                    Visible to public/staff when checked.
                  </p>
                </div>
              </div>
            </div>
