      ...
      <div className="plat-header">
        <div>
          ...
          <p className="plat-header-sub">
            Manage clinical vaccination schedules and age-based milestones.
          </p>
        </div>
      ...
      <div className="plat-card">
        {isLoading ? (
          ...
          <EmptyState
            ...
            description={
              search
                ? `No vaccine records matching "${search}" were found.`
                : 'Start building your clinical immunization schedule by adding your first vaccine.'
            }
                  ...
                  {paginatedData.map((vac: Vaccine & { isHeader?: boolean }, idx: number) => {
                    ...
                    return (
                      <tr key={vac.id} className="plat-table-row">
                        <td
                          data-label="#"
                          className="plat-table-cell font-mono text-[10px] color-muted opacity-60"
                        >
                        ...
                        <td data-label="VACCINE" className="plat-table-cell">
                          <div className="flex items-start gap-3 justify-start">
                            ...
                            <div className="text-left">
                              <div className="font-semibold text-[14px] color-main">
                                {vac.label}
                              </div>
                              {vac.description && (
                        ...
                        <td data-label="AGE" className="plat-table-cell">
                          <div className="flex justify-start">
                            {vac.months !== null && vac.months !== undefined ? (
                              <div
                                className={`plat-badge ${vac.months === 0 ? 'plat-badge-success' : 'plat-badge-info'}`}
                              >
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <button
              ...
              disabled={createVac.isPending || updateVac.isPending}
            >
