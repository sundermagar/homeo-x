    ...
    if (isEdit && patient) {
      setForm({
        ...
        dateOfBirth: patient.dateOfBirth
          ? (new Date(String(patient.dateOfBirth)).toISOString().split('T')[0] ?? '')
          : '',
      });
    }
  }, [isEdit, patient]);
  ...
  return (
    <div className="pp-page-container animate-fade-in">
        ...
        <div>
          ...
          <p className="text-subtitle">
            {isEdit
              ...
              : 'Fill in patient information to create a new registration'}
          </p>
        </div>
      </div>
      ...
      <div className="pp-card" style={{ padding: 0, overflow: 'hidden' }}>
        ...
        >
          <h3 className="text-title" style={{ fontSize: '15px', margin: 0 }}>
            Patient Details
          </h3>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ padding: '20px' }}>
          ...
          <div className="pp-name-grid">
            ...
            <div>
              <label className="text-label" style={{ display: 'block', marginBottom: '6px' }}>
                First Name <span style={{ color: 'var(--pp-danger-fg)' }}>*</span>
              </label>
              <input
                className="pp-input"
                name="firstName"
            ...
            <div>
              <label className="text-label" style={{ display: 'block', marginBottom: '6px' }}>
                Surname <span style={{ color: 'var(--pp-danger-fg)' }}>*</span>
              </label>
              <input
                className="pp-input"
                name="surname"
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end' }}>
              <label className="plat-checkbox-group">
                <input
                  type="checkbox"
                  name="courierOutstation"
                  checked={form.courierOutstation}
                  onChange={handleChange}
                />
