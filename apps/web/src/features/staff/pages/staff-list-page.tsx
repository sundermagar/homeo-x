...
export default function StaffListPage({ defaultTab }: { defaultTab?: StaffCategory } = {}) {
  ...
  const { data, isLoading } = useStaffList(activeTab, {
    page,
    limit: itemsPerPage,
  ...
  return (
    <div className="plat-page fade-in">
      ...
      <div className="plat-header">
        <div>
          ...
          <p className="plat-header-sub">
            Manage clinical practitioners, support staff, and system administrators.
          </p>
        </div>
          ...
          >
            <button
              ...
              style={{
                ...
                border: 'none',
                height: 40,
                background: viewMode === 'list' ? 'var(--bg-surface-2)' : 'transparent',
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                height: 40,
                background: viewMode === 'grid' ? 'var(--bg-surface-2)' : 'transparent',
      ...
      >
        ...
        >
          {currentTabMeta.label} Registry
        </span>
        <span style={{ fontSize: 12, color: 'var(--text-secondary)', fontWeight: 600 }}>
          Showing {staff.length} of {data?.total || 0}
        </span>
      </div>
                ...
                {staff.map((s: StaffSummary, idx: number) => (
                  <tr key={s.id} className="plat-table-row">
                    ...
                    <td data-label="Profile">
                      <div className="plat-cell-val">
                        <div
                          ...
                          style={{ fontWeight: 700, fontSize: '13.5px', color: 'var(--pp-ink)' }}
                        >
                          {s.name || 'Unknown'}
                        </div>
                        <div
                          style={{
                            fontSize: 10,
                            color: s.gender === 'Female' ? '#db2777' : 'var(--pp-blue)',
                            fontWeight: 800,
                            textTransform: 'uppercase',
                    ...
                    <td data-label="Contact">
                      <div className="plat-cell-val">
                        <div style={{ fontSize: 13, fontWeight: 600 }} className="plat-mono-data">
                          {s.mobile || '—'}
                        </div>
                        ...
                        <div className="plat-cell-val">
                          <span
                            style={{
                              ...
                              padding: '3px 10px',
                              borderRadius: 8,
                              background: `${currentTabMeta.color}15`,
                              textTransform: 'uppercase',
                              letterSpacing: '0.05em',
                              border: `1px solid ${currentTabMeta.color}25`,
                            }}
                          >
                            {s.qualification || 'N/A'}
                          </span>
              ...
              >
                ...
                >
                  <div>
                    <div
                      className="plat-capitalize"
                      style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-main)' }}
                    >
                      {s.name || 'Unknown'}
                    </div>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <span style={{ fontSize: 13, fontWeight: 600 }} className="plat-mono-data">
                      {s.mobile || '—'}
                    </span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <span
                      className={
                        s.isActive ? 'plat-badge plat-badge-info' : 'plat-badge plat-badge-default'
                      }
                    >
