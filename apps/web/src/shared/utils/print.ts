        ...
        <div class="container">
          ...
          <div class="footer">
            <div style="font-size: 10px; color: #94a3b8; font-weight: 600;">
              Electronically generated by Kreed.health Clinical Systems<br>
              ${org.website || ''}
            </div>
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            ...
            <p class="footer-note">Generated on ${format(new Date(), 'dd MMM yyyy, hh:mm a')} | Kreed.health Clinical Systems</p>
          </div>
        </div>
      </body>
    </html>
