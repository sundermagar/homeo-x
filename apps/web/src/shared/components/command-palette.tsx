...
function buildCommands(
  ...
  return [
    ...
    */
    ...
    nav('Staff: Dispensaries', '/platform/staff?tab=dispensaries', <Database size={16} />, ADMIN_CLINIC,
      ['dispensary', 'inventory', 'stock', 'pharmacy']),
    ...
    nav('Settings: Letterhead', '/settings/pdf', <FileText size={16} />, ADMIN_CLINIC,
      ['pdf', 'print', 'header', 'brand', 'letterhead']),
