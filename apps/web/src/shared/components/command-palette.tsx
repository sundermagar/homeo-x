...
// ─── Command Builder ──────────────────────────────────────────────────────────
function buildCommands(navigate: ReturnType<typeof useNavigate>, userRole: Role): CommandItem[] {
  ...
  return [
    ...
    action(
      'action-new-clinic',
      'Add Clinic',
      'Register a new clinic or branch',
      <Plus size={16} />,
      ADMIN_ONLY,
      '/platform/clinics?add=true',
                ...
                return (
                  ...
                  >
                    ...
                    <span>
                      ...
                      {item.sublabel && <span className="cp-item-sublabel">{item.sublabel}</span>}
                    </span>
