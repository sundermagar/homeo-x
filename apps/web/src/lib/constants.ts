...
export const API = {
  ...
  ABHA: {
    RECORD: (patientId: string) => `/abha/patients/${patientId}`,
    LINK: (patientId: string) => `/abha/patients/${patientId}/link`,
    UNLINK: (patientId: string) => `/abha/patients/${patientId}/unlink`,
    VERIFY: (patientId: string) => `/abha/patients/${patientId}/verify`,
    SEARCH: '/abha/search',
  },
