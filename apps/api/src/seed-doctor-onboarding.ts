  ...
  const nodes = [
    ...
    },
    {
      ...
      data: {
        ...
        webhookBody:
          '{"name": "{{doctor_name}}", "email": "{{doctor_email}}", "role": "Doctor", "phone": "{{contact.phone}}"}',
      },
    },
    {
      id: 'node_4',
      ...
      data: {
        ...
        label: 'Message',
        message:
          'Your profile has been created successfully! Download our app and log in using your WhatsApp number.',
        buttons: [],
      },
    },
  ];
