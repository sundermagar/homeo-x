...
export function createSettingsRouter(): Router {
  ...
  router.post(
    '/referrals',
    validate(createReferralSourceSchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.put(
    '/referrals/:id',
    validate(updateReferralSourceSchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.post(
    '/dispensaries',
    validate(createDispensarySchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.put(
    '/dispensaries/:id',
    validate(updateDispensarySchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.post(
    '/cms/pages',
    validate(createStaticPageSchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.put(
    '/cms/pages/:id',
    validate(updateStaticPageSchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.post(
    '/pdf',
    validate(createPdfSettingsSchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.put(
    '/pdf/:id',
    validate(updatePdfSettingsSchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.post(
    '/packages',
    validate(createPackagePlanSchema),
    asyncHandler(async (req: Request, res: Response) => {
  ...
  router.put(
    '/packages/:id',
    validate(updatePackagePlanSchema),
    asyncHandler(async (req: Request, res: Response) => {
