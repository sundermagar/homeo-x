# MMC — Comprehensive Product Plan
...
| 7.5  | Wire routes: /billing/_, /payments/_, /collection/_, /expenses/_              | backend   | 7.3, 7.4   | 4h  |
...
| 8.5  | Wire communication routes: /sms/_, /whatsapp/_, /otp/\*                       | backend   | 8.2-8.4    | 4h  |
...
| 11.10 | Parallel run validation: old MMC + new MMC, 1 week read-only sync      | infra     | 11.9           | 8h  |
