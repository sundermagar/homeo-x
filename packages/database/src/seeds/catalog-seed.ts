...
export async function seedCatalog(db: DbClient) {
  ...
  for (const potency of initialPotencies) {
    try {
      ...
      await db.execute(
        sql`INSERT INTO potencies (id, name, detail) VALUES (${potencyId++}, ${potency.name}, ${potency.detail}) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, detail = EXCLUDED.detail`,
      );
    } catch (e) {
  ...
  try {
    ...
    console.warn(
      '[Seed] Could not fetch potencies, continuing with empty mapping:',
      (e as Error).message,
    );
  }
  ...
  const initialMedicines = [
    {
      name: 'Arnica Montana',
      disease: 'Injury, Bruising & Muscle Pain',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('200C'),
      price: 180,
      stockLevel: 45,
    },
    {
      name: 'Nux Vomica',
      disease: 'Indigestion, Gastritis & Acidity',
      type: 'Dilution',
      category: 'Bio-Chemic',
      potencyId: getPotencyId('30C'),
      price: 210,
      stockLevel: 30,
    },
    {
      name: 'Belladonna',
      disease: 'Throbbing Headache & High Fever',
      type: 'Dilution',
      category: 'Bio-Chemic',
      potencyId: getPotencyId('30C'),
      price: 150,
    ...
    },
    {
      ...
      disease: 'Anxiety & Food Poisoning',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('30C'),
      price: 200,
    ...
    {
      name: 'Pulsatilla',
      disease: 'Cough, Cold & Ear Infections',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('30C'),
      price: 160,
    ...
    {
      name: 'Lycopodium',
      disease: 'Bloating, Gas & Liver issues',
      type: 'Dilution',
      category: 'Patent',
      potencyId: getPotencyId('200C'),
      price: 240,
    ...
    {
      name: 'Ignatia Amara',
      disease: 'Emotional Grief & Stress',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('200C'),
      price: 190,
    ...
    },
    {
      ...
      disease: 'Sudden Fever & Panic Attacks',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('30C'),
      price: 170,
    ...
    {
      name: 'Bryonia Alba',
      disease: 'Dry Cough & Pain on Movement',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('200C'),
      price: 195,
    ...
    {
      name: 'Gelsemium',
      disease: 'Weakness & Flu-like symptoms',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('200C'),
      price: 210,
    ...
    {
      name: 'Sulphur',
      disease: 'Skin Rashes & Intense Itching',
      type: 'Dilution',
      category: 'Generic',
      potencyId: getPotencyId('1M'),
      price: 300,
      stockLevel: 8,
    },
    ...
    {
      name: 'Calcarea Carb',
      disease: 'Calcium Deficiency & Fat Metabolism',
      type: 'Trituration',
      category: 'Bio-Chemic',
      potencyId: getPotencyId('6X'),
      price: 120,
      stockLevel: 60,
    },
    {
      name: 'Ferrum Phos',
      disease: 'Anemia & Inflammation',
      type: 'Trituration',
      category: 'Bio-Chemic',
      potencyId: getPotencyId('12X'),
      price: 130,
      stockLevel: 55,
    },
    {
      name: 'Mag Phos',
      disease: 'Spasms & Nerve Pain',
      type: 'Trituration',
      category: 'Bio-Chemic',
      potencyId: getPotencyId('6X'),
      price: 125,
    ...
    {
      name: 'Kali Phos',
      disease: 'Nervous Exhaustion & Fatigue',
      type: 'Trituration',
      category: 'Bio-Chemic',
      potencyId: getPotencyId('6X'),
      price: 140,
    ...
    {
      name: 'Silicea',
      disease: 'Weak Nails & Brittle Hair',
      type: 'Trituration',
      category: 'Bio-Chemic',
      potencyId: getPotencyId('12X'),
      price: 150,
    ...
    {
      name: 'Calendula',
      disease: 'Open Wounds & Septic Prevention',
      type: 'Mother Tincture',
      category: 'Mother Tincture',
      potencyId: getPotencyId('Q (MT)'),
      price: 350,
      stockLevel: 15,
    },
    {
      name: 'Berberis Vulgaris',
      disease: 'Kidney Stones & Urinary Pain',
      type: 'Mother Tincture',
      category: 'Mother Tincture',
      potencyId: getPotencyId('Q (MT)'),
      price: 420,
    ...
    {
      name: 'Chamomilla',
      disease: 'Teething troubles in Infants',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('30C'),
      price: 160,
    ...
    {
      name: 'Sepia',
      disease: 'Hormonal Imbalance in Women',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('1M'),
      price: 320,
    ...
    {
      name: 'Natrum Mur',
      disease: 'Sun-Headache & Malnutrition',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('200C'),
      price: 210,
    ...
    {
      name: 'Hypericum',
      disease: 'Nerve Injuries & Shooting Pain',
      type: 'Ointment',
      category: 'Topical',
      potencyId: null,
      price: 110,
    ...
    {
      name: 'Apis Mellifica',
      disease: 'Bite/Sting swelling & Edema',
      type: 'Dilution',
      category: 'General',
      potencyId: getPotencyId('30C'),
      price: 180,
  ...
  for (const medicine of initialMedicines) {
    const existing = await db
      .select()
      .from(medicines)
      .where(eq(medicines.name, medicine.name))
      .limit(1);
  ...
  for (const freq of initialFrequencies) {
    const existing = await db
      .select()
      .from(frequencies)
      .where(eq(frequencies.title, freq.title || ''))
      .limit(1);
    if (existing.length === 0) {
