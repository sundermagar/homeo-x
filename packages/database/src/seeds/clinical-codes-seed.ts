...
const icd10Seed = [
  ...
  {
    code: 'J06',
    description: 'Acute upper respiratory infections, multiple sites',
    chapter: 'X',
    category: 'Respiratory',
  },
  {
  ...
  {
    code: 'M53',
    description: 'Other and unspecified dorsopathies, not elsewhere classified',
    chapter: 'XIII',
    category: 'Musculoskeletal',
  },
  ...
  {
    code: 'M63',
    description: 'Disorders of muscle, not elsewhere classified',
    chapter: 'XIII',
    category: 'Musculoskeletal',
  },
  {
  ...
  {
    code: 'M79',
    description: 'Other and unspecified soft tissue disorders',
    chapter: 'XIII',
    category: 'Musculoskeletal',
  },
  {
  ...
  {
    code: 'M85',
    description: 'Other disorders of bone structure and mineralization',
    chapter: 'XIII',
    category: 'Musculoskeletal',
  },
  ...
  {
    code: 'M93',
    description: 'Other osteochondropathy',
    chapter: 'XIII',
    category: 'Musculoskeletal',
  },
  {
  ...
  {
    code: 'M95',
    description: 'Other acquired deformity of musculoskeletal system',
    chapter: 'XIII',
    category: 'Musculoskeletal',
  },
  {
  ...
  {
    code: 'N94',
    description: 'Pain and other conditions associated with female genital organs',
    chapter: 'XIV',
    category: 'Genitourinary',
  },
  ...
  {
    code: 'P07',
    description: 'Disorders of newborn related to short gestation and low birth weight',
    chapter: 'XVI',
    category: 'Perinatal',
  },
  ...
  {
    code: 'R15',
    description: 'Incontinence of feces',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
  ...
  {
    code: 'R39',
    description: 'Other and unspecified symptoms and signs involving the genitourinary system',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
  ...
  {
    code: 'R50',
    description: 'Fever and other physiologic temperature elevation',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  ...
  {
    code: 'R70',
    description: 'Elevated erythrocyte sedimentation rate and other abnormal blood findings',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
  ...
  {
    code: 'R76',
    description: 'Other abnormal findings on serological and microbiological examination',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
  ...
  {
    code: 'R80',
    description: '孤立性血尿 (Isolated hematuria)',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  ...
  {
    code: 'R82',
    description: 'Other abnormal urinary findings',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
    code: 'R83',
    description: 'Abnormal findings on cerebrospinal fluid examination',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
    code: 'R84',
    description: 'Abnormal findings on examination of specimens from respiratory organs and thorax',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
    code: 'R85',
    description:
      'Abnormal findings on examination specimens from digestive organs and abdominal cavity',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
    code: 'R86',
    description: 'Abnormal findings on examination of specimens from male genital organs',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
    code: 'R87',
    description: 'Abnormal findings on examination of specimens from female genital organs',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
    code: 'R88',
    description: 'Abnormal findings on other specimens',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
    code: 'R89',
    description:
      'Abnormal findings on examination of specimens from other organs, systems and tissues',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
  ...
  {
    code: 'R95',
    description: 'Infant death syndrome',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
  ...
  {
    code: 'R97',
    description: 'Postprocedural disorder',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  {
  ...
  {
    code: 'R99',
    description: 'Other ill-defined and unknown causes of mortality',
    chapter: 'XVIII',
    category: 'Symptoms and signs',
  },
  ...
  {
    code: 'S93',
    description: 'Dislocation and sprain of joints and ligaments at ankle, foot and toe',
    chapter: 'XIX',
    category: 'Injuries',
  },
  {
  ...
  {
    code: 'Z12',
    description: 'Encounter for screening for neoplasms',
    chapter: 'XXI',
    category: 'Health status',
  },
  {
  ...
  {
    code: 'Z71',
    description: 'Persons encountering health services for other counseling and medical advice',
    chapter: 'XXI',
    category: 'Health status',
  },
  {
...
const loincSeed = [
  ...
  {
    loincNum: '6690-2',
    component: 'White blood cells (WBC)',
    system: 'BLOOD',
    units: '10*3/uL',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '787-2',
    component: 'Mean corpuscular volume (MCV)',
    system: 'BLOOD',
    units: 'fL',
    scale: 'Qn',
  },
  {
    loincNum: '785-6',
    component: 'Mean corpuscular hemoglobin (MCH)',
    system: 'BLOOD',
    units: 'pg',
    scale: 'Qn',
  },
  {
    loincNum: '786-4',
    component: 'Mean corpuscular hemoglobin concentration (MCHC)',
    system: 'BLOOD',
    units: 'g/dL',
    scale: 'Qn',
  },
  {
    loincNum: '788-0',
    component: 'Red cell distribution width (RDW)',
    system: 'BLOOD',
    units: '%',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '32623-1',
    component: 'Mean platelet volume (MPV)',
    system: 'BLOOD',
    units: 'fL',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '7139-5',
    component: 'Relative lymphocytes count',
    system: 'BLOOD',
    units: '%',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '6298-4',
    component: 'Blood glucose fasting',
    system: 'BLOOD',
    units: 'mg/dL',
    scale: 'Qn',
  },
  {
    loincNum: '4548-4',
    component: 'Hemoglobin A1c (HbA1c)',
    system: 'BLOOD',
    units: '%',
    scale: 'Qn',
  },
  {
    loincNum: '10839-9',
    component: 'HbA1c/Hemoglobin.total',
    system: 'BLOOD',
    units: '%',
    scale: 'Qn',
  },
  {
    loincNum: '32344-4',
    component: 'Calculated plasma osmolality',
    system: 'Serum/Plasma',
    units: 'mOsm/kg',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '1974-5',
    component: 'Bilirubin.conjugated',
    system: 'Serum/Plasma',
    units: 'mg/dL',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '2524-4',
    component: 'Gamma-glutamyl transferase (GGT)',
    system: 'Serum/Plasma',
    units: 'U/L',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '9830-1',
    component: 'Cholesterol/HDL ratio',
    system: 'Serum/Plasma',
    units: 'ratio',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '3026-2',
    component: 'Thyroid stimulating hormone (TSH)',
    system: 'Serum/Plasma',
    units: 'mIU/L',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '5801-6',
    component: 'Urine epithelial cells',
    system: 'URINE',
    units: '/hpf',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '3173-2',
    component: 'Activated partial thromboplastin time (APTT)',
    system: 'Plasma',
    units: 's',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '20570-8',
    component: 'BNP (Brain Natriuretic Peptide)',
    system: 'Serum/Plasma',
    units: 'pg/mL',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '30522-7',
    component: 'High-sensitivity CRP (hs-CRP)',
    system: 'Serum/Plasma',
    units: 'mg/L',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '4537-7',
    component: 'Erythrocyte sedimentation rate (ESR)',
    system: 'BLOOD',
    units: 'mm/h',
    scale: 'Qn',
  },
  {
    loincNum: '40968-7',
    component: 'Anti-streptolysin O (ASO) titer',
    system: 'Serum/Plasma',
    units: 'IU/mL',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '42227-4',
    component: 'Anti-nuclear antibody (ANA)',
    system: 'Serum/Plasma',
    units: '',
    scale: 'Nom',
  },
  ...
  {
    loincNum: '33762-6',
    component: 'Ant-CCP (Cyclic Citrullinated Peptide)',
    system: 'Serum/Plasma',
    units: 'U/mL',
    scale: 'Qn',
  },
  ...
  {
    loincNum: '2501-0',
    component: 'Iron binding capacity (TIBC)',
    system: 'Serum/Plasma',
    units: 'mcg/dL',
    scale: 'Qn',
  },
...
const procedureSeed = [
  ...
  {
    code: 'C001',
    name: 'New Case Consultation',
    category: 'Consultation',
    description: 'Initial consultation with detailed case taking',
  },
  {
    code: 'C002',
  ...
  },
  {
    ...
    category: 'Consultation',
    description: 'Urgent consultation outside schedule',
  },

  // Homeopathic Procedures
  {
    code: 'H001',
    name: 'Constitutional Remedy Administration',
    category: 'Homeopathy',
    description: 'Single constitutional remedy dose',
  },
  {
    code: 'H002',
    name: 'Acute Remedy Administration',
    category: 'Homeopathy',
    description: 'Remedy for acute condition',
  },
  {
    code: 'H003',
    name: 'LM Potency Succession',
    category: 'Homeopathy',
    description: 'LM potency preparation and administration',
  },
  {
    code: 'H004',
    name: 'Complimentary Remedy',
    category: 'Homeopathy',
    description: 'Intermediate or complimentary remedy',
  },
  {
    code: 'H005',
    name: 'Constitutional Medicine Kit',
    category: 'Homeopathy',
    description: 'Monthly constitutional kit preparation',
  },

  // Investigations
  {
    code: 'I001',
    name: 'Blood Glucose Check (Random)',
    category: 'Investigation',
    description: 'Random blood glucose estimation',
  },
  {
    code: 'I002',
    name: 'Blood Pressure Monitoring',
    category: 'Investigation',
    description: 'BP measurement and recording',
  },
  {
    code: 'I003',
    name: 'Urine Examination (Routine)',
    category: 'Investigation',
    description: 'Routine urinalysis',
  },
  {
    code: 'I004',
  ...
  // Administrative
  {
    ...
    description: 'New case file documentation',
  },
  {
    code: 'A002',
    name: 'Medical Certificate Issuance',
    category: 'Administration',
    description: 'Medical certificate preparation',
  },
  {
    code: 'A003',
    name: 'Insurance Form Filling',
    category: 'Administration',
    description: 'Insurance related documentation',
  },
  {
    code: 'A004',
    name: 'Prescription Issuance',
    category: 'Administration',
    description: 'Detailed prescription preparation',
  },
];
...
const labPanelSeed = [
  ...
  {
    code: 'CBCP',
    name: 'CBC + Peripheral Smear',
    description: 'Complete blood count with peripheral smear',
  },
  {
    code: 'MET',
