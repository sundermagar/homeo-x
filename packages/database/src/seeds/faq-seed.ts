...
export async function seedFaqs(db: DbClient) {
  ...
  const faqList = [
    ...
    },
    {
      ...
      detail: 'MMC supports concurrent management of multiple clinic locations using a secure tenant schema isolation architecture.',
      displayOrder: 2
    },
    {
    ...
    },
    {
      ...
      detail: 'The MMC platform is responsive and optimized for secondary devices, including tablets and smartphones, to support mobile clinical management.',
      displayOrder: 12
    },
    {
