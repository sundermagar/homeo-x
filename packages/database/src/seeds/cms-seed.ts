  ...
  const pages = [
    {
      slug: 'about-us',
      title: 'About MMC',
      content: 'MMC is a comprehensive clinical management platform specialized for homeopathy.',
    },
    {
      slug: 'privacy-policy',
      title: 'Privacy Policy',
      content: 'We value your privacy and data security.',
    },
    {
      slug: 'terms-of-service',
      title: 'Terms of Service',
      content: 'Standard terms of service for clinical management.',
    },
  ];
