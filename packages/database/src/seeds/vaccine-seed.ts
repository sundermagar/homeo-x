...
const vaccineSeed = [
  ...
  {
    id: 2185,
    label: 'Diphtheria, tetanus, and acellular pertussis (DTaP) - D1',
    months: 2,
    parentId: 2170,
  },
  ...
  {
    id: 2188,
    label: 'Diphtheria, tetanus, and acellular pertussis (DTaP) - D2',
    months: 4,
    parentId: 2171,
  },
  ...
  {
    id: 2191,
    label: 'Pneumococcal conjugate vaccines (PCV10 or PCV13) - D1',
    months: 4,
    parentId: 2171,
  },
  ...
  {
    id: 2193,
    label: 'Diphtheria, tetanus, and acellular pertussis (DTaP) - D3',
    months: 6,
    parentId: 2172,
  },
  ...
  {
    id: 2196,
    label: 'Pneumococcal conjugate vaccines (PCV10 or PCV13) - D2',
    months: 6,
    parentId: 2172,
  },
  {
    id: 2197,
    label: 'Pneumococcal conjugate vaccines (PCV10 or PCV13) - B1',
    months: 12,
    parentId: 2173,
  },
  ...
  {
    id: 2202,
    label: 'Diphtheria, tetanus, and acellular pertussis (DTaP) - B1',
    months: 18,
    parentId: 2175,
  },
  ...
  {
    id: 2206,
    label: 'Tetanus, reduced diphtheria and acellular pertussis (tdap) - B2',
    months: 120,
    parentId: 2178,
  },
  {
    id: 2207,
    label: 'Human papillomavirus (HPV2 or HPV4) - D1 (Females)',
    months: 144,
    parentId: 2179,
  },
  {
    id: 2208,
    label: 'Human papillomavirus (HPV2 or HPV4) - D2 (Females)',
    months: 156,
    parentId: 2180,
  },
  {
    id: 2209,
    label: 'Pneumococcal polysaccharide (PPSV23) - (One or two dose)',
    months: 24,
    parentId: 2176,
  },
  {
    id: 2215,
    label: 'Influenza (INF) - Annual vaccination (6-59 months)',
    months: 6,
    parentId: 2172,
  },
];
