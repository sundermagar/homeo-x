...
export const snomedConcepts = pgTable(
  'snomed_concepts',
  {
    id: serial('id').primaryKey(),
...
// ─── LOINC Master Table ───────────────────────────────────────────────────────
export const loincCodes = pgTable(
  'loinc_codes',
  {
    id: serial('id').primaryKey(),
...
export const labPanelLoincLinks = pgTable('lab_panel_loinc_links', {
  id: serial('id').primaryKey(),
  labPanelId: integer('lab_panel_id')
    .notNull()
    .references(() => labPanels.id),
  loincCodeId: integer('loinc_code_id')
    .notNull()
    .references(() => loincCodes.id),
...
export const medicalCaseDiagnoses = pgTable('medical_case_diagnoses', {
  id: serial('id').primaryKey(),
  medicalCaseId: integer('medical_case_id')
    .notNull()
