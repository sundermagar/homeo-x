...
export const remedyProfiles = pgTable(
  'remedy_profiles',
  {
    id: serial('id').primaryKey(),
...
export const rubricRemedyMap = pgTable(
  'rubric_remedy_map',
  {
    id: serial('id').primaryKey(),
...
// ─── Extended SOAP Notes ──────────────────────────────────────────────────────
export const extendedSoapNotes = pgTable(
  'soap_notes',
  {
    id: serial('id').primaryKey(),
...
export const extendedPrescriptions = pgTable(
  'prescriptions',
  {
    id: serial('id').primaryKey(),
    tenantId: varchar('tenant_id', { length: 50 }),
...
export const mlTrainingLogs = pgTable(
  'ml_training_logs',
  {
    id: serial('id').primaryKey(),
    tenantId: varchar('tenant_id', { length: 50 }),
...
export const mlTrainingEmbeddings = pgTable(
  'ml_training_embeddings',
  {
    id: serial('id').primaryKey(),
  ...
  (table) => ({
    ...
    embeddingIdx: index('idx_ml_training_embeddings_hnsw').using(
      'hnsw',
