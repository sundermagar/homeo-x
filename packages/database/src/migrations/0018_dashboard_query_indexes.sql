...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_bills_billdate_regid_active' AND schemaname = current_schema()) THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_bills_billdate_charges_regid' AND schemaname = current_schema()) THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_bills_created_active' AND schemaname = current_schema()) THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'receipt' AND table_schema = current_schema()) THEN
        ...
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_receipt_created_regid_active' AND schemaname = current_schema()) THEN
        ...
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_receipt_created_desc_active' AND schemaname = current_schema()) THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'expenses' AND table_schema = current_schema()) THEN
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_expenses_clinic_date_active' AND schemaname = current_schema()) THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'waitlist' AND table_schema = current_schema()) THEN
        ...
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_waitlist_clinic_date_wait' AND schemaname = current_schema()) THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'case_reminders' AND table_schema = current_schema()) THEN
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_case_reminders_clinic_pending' AND schemaname = current_schema()) THEN
