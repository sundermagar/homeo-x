...
--> statement-breakpoint
ALTER TABLE "bills" ADD CONSTRAINT "bills_regid_case_datas_regid_fk" FOREIGN KEY ("regid") REFERENCES "public"."case_datas"("regid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payments" ADD CONSTRAINT "payments_regid_case_datas_regid_fk" FOREIGN KEY ("regid") REFERENCES "public"."case_datas"("regid") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
